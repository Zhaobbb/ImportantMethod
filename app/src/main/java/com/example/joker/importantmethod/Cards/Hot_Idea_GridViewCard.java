...
import com.example.joker.importantmethod.RecyclerViews.MyGridViewAdapter;
...
//            map.put("image", BitmapHelper.getBitmap(hot_idea_img.get(i)));
...
//                R.id.hot_idea_img, R.id.hot_idea_title,R.id.hot_idea_provider,R.id.hot_idea_interestnum });
        ...
        MyGridViewAdapter adapter=new MyGridViewAdapter(hot_idea_img,hot_idea_title,hot_idea_provider,hot_idea_interestnum,getContext());
