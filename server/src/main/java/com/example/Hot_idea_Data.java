...
public class Hot_idea_Data extends BaseData {
    ...
    public Hot_idea_Data(ArrayList<String> hot_idea_img, ArrayList<String> hot_idea_text, ArrayList<String> hot_idea_provider, ArrayList<Integer> hot_idea_interestnum) {
        this.hot_idea_img = hot_idea_img;
